...
RSpec.describe Post, type: :model do
  ...
  it 'title should not be greater than 250 characters' do
    post = Post.create(user:, title: 'a' * 251, text: 'This is exciting!')
  ...
  # it 'increments the user\'s posts_counter after save' do
  #   expect { subject }.to change { user.reload.posts_counter }.by(1)
  # end
end
